...
actual fun readResourceContainer(language: String, resource: String): List<Workbook> {
    val directoryProvider = getKoin().get<DirectoryProvider>()
    val resource = Path(directoryProvider.sources, "${language}_$resource.zip")
