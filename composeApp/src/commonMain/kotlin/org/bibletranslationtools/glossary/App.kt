...
import org.bibletranslationtools.glossary.platform.setStatusBarLight
...
fun App(root: RootComponent) {
    ...
    val colorScheme = when (theme) {
        ...
        Theme.SYSTEM if isSystemInDarkTheme() -> DarkColorScheme
        else -> LightColorScheme
    }
    setStatusBarLight(colorScheme == LightColorScheme)
